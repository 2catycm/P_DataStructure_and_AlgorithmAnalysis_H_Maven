...
//        System.arraycopy(source, 0, prefixSum, 1, source.length);//different type.
...
class IntDoublingSTTable {
    ...
    //    public int indexOfMax(int startInclusiveStartingFrom1, int endExclusiveStartingFrom1) {
//        int max_exponent = (int) (Math.log(endExclusiveStartingFrom1 - startInclusiveStartingFrom1) / Math.log(2));
//        final var i1 = st[startInclusiveStartingFrom1][max_exponent];
//        final var i2 = st[endExclusiveStartingFrom1 - (1 << max_exponent)][max_exponent];
//        if (source[i1-1]>source[i2-1])
//            return i1;
//        else return i2;
//    }
}
