...
//class HigherInLowerOutStack extends IntArrayStack{
//    public HigherInLowerOutStack() {
//    }
//
//    public HigherInLowerOutStack(int initialCapacity) {
//        super(initialCapacity);
//    }
//
//    @Override
//    public int 可扩容入栈(int item) {
//        int i = 0;
//        while (!super.栈空()&&super.栈顶()<=item){
//            super.出栈();
//            i++;
//        }
//        super.可扩容入栈(item);
...
//
//    @Override
//    public int 入栈(int item) throws ArrayIndexOutOfBoundsException {
//        while (!super.栈空()&&super.栈顶()<=item){
//            super.出栈();
//        }
//        super.入栈(item);
